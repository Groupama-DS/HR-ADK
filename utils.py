...
async def display_state(
    ...
    try:
        ...
        # Handle the medical insurance package
        pachet_asigurare = session.state.get("pachet_asigurare", "Unknown")
        print(f"🏥 Medical Insurance Package: {pachet_asigurare}")

        # Handle the bonus schema
        schema_bonus = session.state.get("schema_bonus", "Unknown")
        print(f"💰 Bonus Schema: {schema_bonus}")
